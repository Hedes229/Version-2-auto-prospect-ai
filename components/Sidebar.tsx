...
import { LayoutDashboard, Users, Send, Settings, Database, Sparkles, BarChart3 } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, leadCount }) => {
  const menuItems = [
  ...
  return (
    <div className="w-64 bg-slate-900 text-white h-screen flex flex-col fixed left-0 top-0 z-10 hidden md:flex border-r border-slate-800">
      ...
      <div className="p-4 border-t border-slate-800 bg-slate-900/50">
        ...
        <div className="mt-4 px-4">
           <div className="bg-slate-800/50 border border-slate-800 rounded-2xl p-4">
              ...
              <p className="text-right text-[10px] font-mono text-slate-400 mt-2">4,520 / 10,000 pts</p>
           </div>
        </div>
      </div>
    </div>
